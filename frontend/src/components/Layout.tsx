    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="fixed left-6 top-1/2 transform -translate-y-1/2 z-50 space-y-4 hidden lg:block">
        ...
        <a
          ...
          className="block w-12 h-12 bg-slate-800/50 backdrop-blur-xl rounded-full flex items-center justify-center text-slate-400 hover:text-green-400 hover:bg-green-500/20 transition-all duration-300 group border border-slate-700/50"
        >
        ...
        <a
          href="tel:+6587373057"
          className="block w-12 h-12 bg-slate-800/50 backdrop-blur-xl rounded-full flex items-center justify-center text-slate-400 hover:text-purple-400 hover:bg-purple-500/20 transition-all duration-300 group border border-slate-700/50"
        >
